...
export function FindingsSection({ productOnly = false, onProductSaved }: { productOnly?: boolean; onProductSaved?: () => Promise<void> | void }) {
  ...
  useEffect(() => { if (!productOnly) void load(); }, [productOnly]);
  ...
  return <section className={productOnly ? "finding-section product-link-import mb-4 p-0" : "finding-section card-soft mb-6 p-4"}>
