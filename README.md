...
- O filtro de preço não altera a moeda registrada. Registro 245.
- A documentação acompanha ajustes reversíveis. Registro 246.
- O servidor preserva respostas consistentes em falhas. Registro 247.
- O layout mantém legibilidade em diferentes larguras. Registro 248.
- A API separa dados de produto e dados de promoção. Registro 249.
- A revisão preserva mudanças locais antes de salvar. Registro 250.
- Mídias sem URL válida não entram na galeria. Registro 251.
- Consultas de estoque não criam disponibilidade fictícia. Registro 252.
- A lista mantém o produto escolhido após uma edição. Registro 253.
- O filtro de preço não altera a moeda registrada. Registro 254.
- A documentação acompanha ajustes reversíveis. Registro 255.
- O servidor preserva respostas consistentes em falhas. Registro 256.
- O layout mantém legibilidade em diferentes larguras. Registro 257.
- A API separa dados de produto e dados de promoção. Registro 258.
...
- A documentação acompanha ajustes reversíveis. Registro 264.
- O servidor preserva respostas consistentes em falhas. Registro 265.
- O layout mantém legibilidade em diferentes larguras. Registro 266.
- A API separa dados de produto e dados de promoção. Registro 267.
- A revisão preserva mudanças locais antes de salvar. Registro 268.
- Mídias sem URL válida não entram na galeria. Registro 269.
...
- A URL externa é verificada antes de abrir uma nova aba. Registro 284.
- A interface mantém separação entre dados pessoais e promoções. Registro 285.
- Pequenos ajustes permanecem descritos na documentação. Registro 286.
- O produto mantém o identificador ao ser atualizado. Registro 287.
- A navegação não duplica requisições já concluídas. Registro 288.
- Mídias válidas permanecem disponíveis na revisão. Registro 289.
- A disponibilidade preserva a evidência coletada. Registro 290.
- O preço não é arredondado sem regra explícita. Registro 291.
- O frete não é inferido por informações de catálogo. Registro 292.
- A URL externa é verificada antes de abrir uma nova aba. Registro 293.
- A interface mantém separação entre dados pessoais e promoções. Registro 294.
- Pequenos ajustes permanecem descritos na documentação. Registro 295.
- O produto mantém o identificador ao ser atualizado. Registro 296.
- A navegação não duplica requisições já concluídas. Registro 297.
- Mídias válidas permanecem disponíveis na revisão. Registro 298.
- A disponibilidade preserva a evidência coletada. Registro 299.
- O preço não é arredondado sem regra explícita. Registro 300.
...
- O produto mantém o identificador ao ser atualizado. Registro 305.
...
- O preço informado pelo usuário permanece editável. Registro 320.
- A disponibilidade só muda com evidência nova. Registro 321.
- O frete não é exibido quando a origem não confirma valor. Registro 322.
...
- A interface separa ações de abrir, editar e remover. Registro 332.
...
- A galeria mantém uma mídia principal definida. Registro 337.
- O preço informado pelo usuário permanece editável. Registro 338.
- A disponibilidade só muda com evidência nova. Registro 339.
- O frete não é exibido quando a origem não confirma valor. Registro 340.
- A interface separa ações de abrir, editar e remover. Registro 341.
- Os dados de promoções não substituem dados importados. Registro 342.
- A documentação registra garantias de manutenção. Registro 343.
- A aplicação mantém a seleção atual após atualizar listas. Registro 344.
- O formulário não perde a URL durante a análise. Registro 345.
- A galeria mantém uma mídia principal definida. Registro 346.
- O preço informado pelo usuário permanece editável. Registro 347.
- A disponibilidade só muda com evidência nova. Registro 348.
...
- A aplicação mantém a seleção atual após atualizar listas. Registro 353.
...
- A disponibilidade não é convertida sem dados de tamanho. Registro 359.
...
- A documentação registra decisões pequenas e reversíveis. Registro 364.
...
- O preço original permanece separado do promocional. Registro 369.
- O frete desconhecido permanece sem valor exibido. Registro 370.
- A URL normalizada ajuda a evitar duplicidade. Registro 371.
- O backend mantém verificações de segurança por requisição. Registro 372.
- A documentação registra decisões pequenas e reversíveis. Registro 373.
- A lista preserva dados carregados durante novas consultas. Registro 374.
- O modal mantém campos editáveis até a confirmação. Registro 375.
...
- O modal mantém campos editáveis até a confirmação. Registro 384.
- A galeria usa apenas mídias relacionadas ao produto. Registro 385.
...
- A galeria usa apenas mídias relacionadas ao produto. Registro 394.
- O modal mantém ações acessíveis em telas compactas. Registro mobile 1.
- A rolagem interna não oculta controles importantes. Registro mobile 2.
- O botão salvar permanece fora do conteúdo rolável. Registro mobile 3.
- A área segura do dispositivo é respeitada no rodapé. Registro mobile 4.
- A interface preserva espaçamento entre ações principais. Registro mobile 5.
- O formulário continua editável durante a revisão. Registro mobile 6.
- A galeria não altera a posição das ações de salvamento. Registro mobile 7.
- A documentação registra o comportamento responsivo. Registro mobile 8.
- Pequenos ajustes de interface permanecem reversíveis. Registro mobile 9.
- O modal mantém ações acessíveis em telas compactas. Registro mobile 10.
- A rolagem interna não oculta controles importantes. Registro mobile 11.
- O botão salvar permanece fora do conteúdo rolável. Registro mobile 12.
- A área segura do dispositivo é respeitada no rodapé. Registro mobile 13.
...
- Pequenos ajustes de interface permanecem reversíveis. Registro mobile 18.
- O modal mantém ações acessíveis em telas compactas. Registro mobile 19.
- A rolagem interna não oculta controles importantes. Registro mobile 20.
- O botão salvar permanece fora do conteúdo rolável. Registro mobile 21.
- A área segura do dispositivo é respeitada no rodapé. Registro mobile 22.
- A interface preserva espaçamento entre ações principais. Registro mobile 23.
- O formulário continua editável durante a revisão. Registro mobile 24.
- A galeria não altera a posição das ações de salvamento. Registro mobile 25.
- A documentação registra o comportamento responsivo. Registro mobile 26.
- Pequenos ajustes de interface permanecem reversíveis. Registro mobile 27.
- O modal mantém ações acessíveis em telas compactas. Registro mobile 28.
- A rolagem interna não oculta controles importantes. Registro mobile 29.
- O botão salvar permanece fora do conteúdo rolável. Registro mobile 30.
- A área segura do dispositivo é respeitada no rodapé. Registro mobile 31.
- A interface preserva espaçamento entre ações principais. Registro mobile 32.
- O formulário continua editável durante a revisão. Registro mobile 33.
- A galeria não altera a posição das ações de salvamento. Registro mobile 34.
- A documentação registra o comportamento responsivo. Registro mobile 35.
- Pequenos ajustes de interface permanecem reversíveis. Registro mobile 36.
- O modal mantém ações acessíveis em telas compactas. Registro mobile 37.
- A rolagem interna não oculta controles importantes. Registro mobile 38.
- O botão salvar permanece fora do conteúdo rolável. Registro mobile 39.
...
- A documentação registra o comportamento responsivo. Registro mobile 44.
- Pequenos ajustes de interface permanecem reversíveis. Registro mobile 45.
- O modal mantém ações acessíveis em telas compactas. Registro mobile 46.
- A rolagem interna não oculta controles importantes. Registro mobile 47.
...
- A galeria permanece dentro da área rolável do formulário. Registro 10 desta rodada.
- A documentação registra uma garantia de usabilidade. Registro 11 desta rodada.
- Pequenos ajustes permanecem isolados e reversíveis. Registro 12 desta rodada.
- A interface mantém botões de ação visíveis no fluxo de revisão. Registro 13 desta rodada.
- A rolagem não impede o acesso à confirmação de salvamento. Registro 14 desta rodada.
- O conteúdo do modal respeita a altura disponível da tela. Registro 15 desta rodada.
<!-- maintenance-notes -->
