...
function serialize(
  ...
  return {
    ...
    purchaseIntent: product.purchaseIntent,
    estimatedUses: product.estimatedUses,
    timesPostponed: product.timesPostponed,
...
export const productService = {
  ...
  async create(
    ...
    const product = await productRepository.create({
      ...
      purchaseIntent: String(data.purchaseIntent || "WANT"),
      estimatedUses: data.estimatedUses != null && data.estimatedUses !== "" ? Number(data.estimatedUses) : null,
